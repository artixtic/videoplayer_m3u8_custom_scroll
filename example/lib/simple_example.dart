...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Simple API Video Player',
      theme: ThemeData.dark(),
      home: const SimpleVideoDemo(),
    );
  }
}

class SimpleVideoDemo extends StatelessWidget {
  const SimpleVideoDemo({super.key});

  @override
  Widget build(BuildContext context) {
    // Your API data - just pass it directly!
    final apiData = {
      "fileUrl":
    ...
    // That's it! Just pass your API data and you're done!
    return ApiVideoPlayerScreen(
      apiData: apiData,
      title: 'Doorbell Camera - Front Door',
